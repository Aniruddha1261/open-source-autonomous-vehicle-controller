...
import { u as useData, d as computedAsync, e as useSessionStorage, f as useLocalStorage, w as watchDebounced, o as onKeyStroke, g as createTranslate, h as useEventListener, i as useScrollLock } from "./theme.97e80fa4.js";
const localSearchIndex = { "root": () => __vitePreload(() => import("./@localSearchIndexroot.2299d17e.js"), true ? [] : void 0) };
class DOMIterator {
  /**
...
const _withScopeId = (n) => (pushScopeId("data-v-0655ad12"), n = n(), popScopeId(), n);
...
const _hoisted_3 = { class: "search-actions before" };
...
const _hoisted_15 = ["href", "aria-label", "onMouseenter"];
const _hoisted_16 = { class: "titles" };
const _hoisted_17 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("span", { class: "title-icon" }, "#", -1));
const _hoisted_18 = ["innerHTML"];
const _hoisted_19 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("svg", {
  width: "18",
  height: "18",
  viewBox: "0 0 24 24"
}, [
...
const _hoisted_20 = { class: "title main" };
...
const _hoisted_25 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", { class: "excerpt-gradient-bottom" }, null, -1));
const _hoisted_26 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", { class: "excerpt-gradient-top" }, null, -1));
const _hoisted_27 = {
  key: 0,
  class: "no-results"
};
const _hoisted_28 = { class: "search-keyboard-shortcuts" };
...
const _hoisted_33 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("svg", {
  width: "14",
  height: "14",
  viewBox: "0 0 24 24"
}, [
    ...
    watchDebounced(
      ...
      async ([index, filterTextValue, showDetailedListValue], old, onCleanup) => {
        ...
        for (const { id, mod } of mods) {
          ...
          if (comp == null ? void 0 : comp.render) {
      ...
      return openBlock(), createBlock(Teleport, { to: "body" }, [
        createBaseVNode("div", {
          ...
          createBaseVNode("div", _hoisted_1, [
            createBaseVNode("div", {
              class: "search-bar",
              onPointerup: _cache[5] || (_cache[5] = ($event) => onSearchBarClick($event))
            }, [
              _hoisted_2,
              ...
              createBaseVNode("div", _hoisted_8, [
                !disableDetailedView.value ? (openBlock(), createElementBlock("button", {
                  ...
                  onClick: _cache[3] || (_cache[3] = ($event) => showDetailedList.value = !unref(showDetailedList))
                }, _hoisted_11, 10, _hoisted_9)) : createCommentVNode("", true),
                createBaseVNode("button", {
                  class: "clear-button",
                  title: unref($t)("modal.resetButtonTitle"),
                  onClick: _cache[4] || (_cache[4] = ($event) => filterText.value = "")
            ...
            createBaseVNode("div", {
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(results.value, (p, index) => {
                return openBlock(), createElementBlock("a", {
                  ...
                  createBaseVNode("div", null, [
                    ...
                    unref(showDetailedList) ? (openBlock(), createElementBlock("div", _hoisted_22, [
                      p.text ? (openBlock(), createElementBlock("div", _hoisted_23, [
                        createBaseVNode("div", {
                          class: "vp-doc",
                          innerHTML: p.text
                        }, null, 8, _hoisted_24)
              ...
              unref(filterText) && !results.value.length && enableNoResults.value ? (openBlock(), createElementBlock("div", _hoisted_27, [
...
const VPLocalSearchBox_vue_vue_type_style_index_0_scoped_0655ad12_lang = "";
const VPLocalSearchBox = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0655ad12"]]);
export {
